...
public class NativeAdvanceAd extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_native_advance_ad);
        ...
        builder.forNativeAd(
                new NativeAd.OnNativeAdLoadedListener() {
                    ...
                    public void onNativeAdLoaded(NativeAd nativeAd) {
                        ...
                        if (NativeAdvanceAd.this.nativeAd != null) {
                            NativeAdvanceAd.this.nativeAd.destroy();
                        }
                        NativeAdvanceAd.this.nativeAd = nativeAd;
