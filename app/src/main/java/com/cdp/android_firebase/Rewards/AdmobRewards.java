package com.cdp.android_firebase.Rewards;
...
import com.cdp.android_firebase.R;
...
public class AdmobRewards extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admob_rewards);
            ...
            RewardedInterstitialAd.load(
                    ...
                    new RewardedInterstitialAdLoadCallback() {
                        ...
                        public void onAdLoaded(RewardedInterstitialAd ad) {
                            ...
                            isLoadingAds = false;
                            Toast.makeText(AdmobRewards.this, "onAdLoaded", Toast.LENGTH_SHORT).show();
                        }
                        ...
                        public void onAdFailedToLoad(LoadAdError loadAdError) {
                            ...
                            isLoadingAds = false;
                            Toast.makeText(AdmobRewards.this, "onAdFailedToLoad", Toast.LENGTH_SHORT).show();
                        }
                    });
        }
    }
    ...
    private void showRewardedVideo() {
        ...
        rewardedInterstitialAd.setFullScreenContentCallback(
                new FullScreenContentCallback() {
                    ...
                    public void onAdShowedFullScreenContent() {
                        ...
                        Toast.makeText(AdmobRewards.this, "onAdShowedFullScreenContent", Toast.LENGTH_SHORT)
                                .show();
                    }
                    ...
                    public void onAdFailedToShowFullScreenContent(AdError adError) {
                        ...
                        loadRewardedInterstitialAd();
                        Toast.makeText(
                                AdmobRewards.this, "onAdFailedToShowFullScreenContent", Toast.LENGTH_SHORT)
                                .show();
                    }
                    ...
                    public void onAdDismissedFullScreenContent() {
                        ...
                        Toast.makeText(AdmobRewards.this, "onAdDismissedFullScreenContent", Toast.LENGTH_SHORT)
                                .show();
        ...
        Activity activityContext = AdmobRewards.this;
